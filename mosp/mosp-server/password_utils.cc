...
std::string mosp::HashPassword(std::string password, std::string salt)
{
...
void mosp::BytesToHex(const unsigned char* data, size_t length,
	std::string& str)
{
	// Clear output
	str.clear();
...
void mosp::HexToBytes(const std::string& str,
